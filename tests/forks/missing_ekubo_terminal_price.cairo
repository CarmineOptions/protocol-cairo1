...
fn test_missing_ekubo_terminal_price() {
    // New AMM Hash: 0x01313b44618af33738511f02ce2ae9092f2bdf62528a4a7f3c5ebd8c16dac594

    // Missing maturities: 1744329599, 1744934399, 1745539199
    let mat1: u64 = 1744329599;
    let mat2: u64 = 1744934399;
    let mat3: u64 = 1745539199;
    let _mat4: u64 = 1743724799; // This one works fine
    ...
    let _eprice4 = amm.get_terminal_price(quote_token, eth_address, _mat4);
    ...
    let _sprice4 = amm.get_terminal_price(quote_token, strk_address, _mat4);

    let ekubo_correct_price = amm.get_terminal_price(quote_token, base_token, _mat4);

    start_prank(amm_contract_addr, owner);
    let new_amm_hash = 0x01313b44618af33738511f02ce2ae9092f2bdf62528a4a7f3c5ebd8c16dac594;
    ...
    assert(_eprice4 == amm.get_terminal_price(quote_token, eth_address, _mat4), 'price changed4');
    ...
    assert(_sprice4 == amm.get_terminal_price(quote_token, strk_address, _mat4), 'price changed8');

    assert(
        ekubo_correct_price == amm.get_terminal_price(quote_token, base_token, _mat4),
        'price changed9'
    );
}

...
fn test_trade_open_long() {
    ...
    assert(stats_1.bal_eth + stats_1.unlocked_capital_c + stats_1.locked_capital_c == 2*five_tokens, 'random eth appeared');
    assert(stats_1.bal_usdc+ stats_1.unlocked_capital_p + stats_1.locked_capital_p == 2* five_k_tokens, 'random usdc appeared');
    ...
    assert(stats_1.pool_pos_val_c == FixedTrait::from_felt(18382745762695790568), 'Call1 pos val wrong');
    assert(stats_1.pool_pos_val_p == FixedTrait::from_felt(25665977665455938802040), 'Put1 pos val wrong');
...
fn test_trade_open_short() {
    ...
    assert(short_put_premia == FixedTrait::from_felt(1875771037947335154100),'Long put premia wrong');
    ...
    assert(stats_1.pool_pos_val_c == FixedTrait::from_felt(27791151886514810), 'Call1 pos val wrong');
    assert(stats_1.pool_pos_val_p == FixedTrait::from_felt(1819497906808915099526), 'Put1 pos val wrong');

    assert(stats_1.volatility_c == FixedTrait::from_felt(1475739525896764129300), 'Call1 vol wrong');

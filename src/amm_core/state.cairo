mod State {
    ...
    fn get_available_options(lptoken_address: LPTAddress, idx: u32) -> Option_ {
        ...
        let usable_index = state.new_available_options_usable_index.read();
        if usable_index == 0 {
    ...
    fn append_to_available_options(option: Option_, lptoken_address: LPTAddress) {
        ...
        state.new_available_options_usable_index.write(usable_index + 1);
    }
    ...
    fn get_lptoken_address_for_given_option(
        ...
        let lpt_address = AMM::unsafe_new_contract_state()

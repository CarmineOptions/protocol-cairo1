...
fn get_test_std_normal_cdf_cases() -> Array<(Fixed, Fixed)> {
    ...
    arr.append((FixedTrait::from_felt(64800229984264355840), FixedTrait::from_felt(18442654751404615680)));
    arr.append((FixedTrait::from_felt(58312136748854312960), FixedTrait::from_felt(18432247643905175552)));
    arr.append((FixedTrait::from_felt(-48184060197361451008), FixedTrait::from_felt(83008164005589360)));
    arr.append((FixedTrait::from_felt(-40539702722723512320), FixedTrait::from_felt(258007448778362336)));
    arr.append((FixedTrait::from_felt(101923126309447892992), FixedTrait::from_felt(18446743770268907520)));
    arr.append((FixedTrait::from_felt(-63083991958638624768), FixedTrait::from_felt(5780239419541288)));
    arr.append((FixedTrait::from_felt(28162466146725199872), FixedTrait::from_felt(17276869749314291712)));
    arr.append((FixedTrait::from_felt(-88192507920352870400), FixedTrait::from_felt(16093869139577)));
    arr.append((FixedTrait::from_felt(-78468888490706239488), FixedTrait::from_felt(193844374173112)));
    arr.append((FixedTrait::from_felt(28060374979069247488), FixedTrait::from_felt(17264116852247371776)));
    arr.append((FixedTrait::from_felt(94552108071591936000), FixedTrait::from_felt(18446741339296153600)));
    arr.append((FixedTrait::from_felt(126995597826164457472), FixedTrait::from_felt(18446744073656043520)));
    arr.append((FixedTrait::from_felt(-62372937558596583424), FixedTrait::from_felt(6655447769788865)));
    arr.append((FixedTrait::from_felt(122848937580332089344), FixedTrait::from_felt(18446744073456396288)));
    arr.append((FixedTrait::from_felt(-141281801947675754496), FixedTrait::from_felt(172965)));
    arr.append((FixedTrait::from_felt(62755858162703237120), FixedTrait::from_felt(18440574175010328576)));
    arr.append((FixedTrait::from_felt(102069095219063259136), FixedTrait::from_felt(18446743783650828288)));
    arr.append((FixedTrait::from_felt(-116572351975961001984), FixedTrait::from_felt(2421882545)));
    arr.append((FixedTrait::from_felt(76011819007279857664), FixedTrait::from_felt(18446395548030355456)));
    arr.append((FixedTrait::from_felt(-142753852756396310528), FixedTrait::from_felt(92636)));
    arr.append((FixedTrait::from_felt(54281970277190926336), FixedTrait::from_felt(18416727943673896960)));
    arr.append((FixedTrait::from_felt(-28758192813155647488), FixedTrait::from_felt(1097581163086414976)));
    arr.append((FixedTrait::from_felt(131903204858025443328), FixedTrait::from_felt(18446744073701576704)));
    arr.append((FixedTrait::from_felt(7620224593559715840), FixedTrait::from_felt(12179109250831343616)));
    arr.append((FixedTrait::from_felt(35733331703604969472), FixedTrait::from_felt(17960375668118048768)));
    arr.append((FixedTrait::from_felt(76960895424288522240), FixedTrait::from_felt(18446465656903213056)));
    arr.append((FixedTrait::from_felt(-9764929877766799360), FixedTrait::from_felt(5502268911090464768)));
    ...
    arr.append((FixedTrait::from_felt(42666205868167397376), FixedTrait::from_felt(18255580859719563264)));
    arr.append((FixedTrait::from_felt(-69939943924746911744), FixedTrait::from_felt(1381376337987086)));
    arr.append((FixedTrait::from_felt(5897761236622802944), FixedTrait::from_felt(11536760657208780800)));
    arr.append((FixedTrait::from_felt(57476019185036492800), FixedTrait::from_felt(18429823030984329216)));
    arr.append((FixedTrait::from_felt(85025547206671859712), FixedTrait::from_felt(18446706798786672640)));
    arr.append((FixedTrait::from_felt(59635370397632888832), FixedTrait::from_felt(18435439334488442880)));
    arr.append((FixedTrait::from_felt(145814538742669410304), FixedTrait::from_felt(18446744073709527040)));
    arr.append((FixedTrait::from_felt(-145203862804605140992), FixedTrait::from_felt(32315)));
    arr.append((FixedTrait::from_felt(37745173177238487040), FixedTrait::from_felt(18070987088780298240)));
    arr.append((FixedTrait::from_felt(-109187138174932615168), FixedTrait::from_felt(29866493772)));
    arr.append((FixedTrait::from_felt(51528775649317715968), FixedTrait::from_felt(18398634694787383296)));
    arr.append((FixedTrait::from_felt(28511272757997010944), FixedTrait::from_felt(17319635133324185600)));
    arr.append((FixedTrait::from_felt(66224525511740358656), FixedTrait::from_felt(18443694560887629824)));
    arr.append((FixedTrait::from_felt(-82090144194716205056), FixedTrait::from_felt(79158729738176)));
    arr.append((FixedTrait::from_felt(-67283806607978299392), FixedTrait::from_felt(2442745391761175)));
    arr.append((FixedTrait::from_felt(30759886744565809152), FixedTrait::from_felt(17566689944762902528)));
    arr.append((FixedTrait::from_felt(106201558586106576896), FixedTrait::from_felt(18446743994829830144)));
    arr.append((FixedTrait::from_felt(-123177416101368102912), FixedTrait::from_felt(224235946)));
    arr.append((FixedTrait::from_felt(43338696574693900288), FixedTrait::from_felt(18273308485610815488)));
    arr.append((FixedTrait::from_felt(-101583844709702696960), FixedTrait::from_felt(336899512454)));
    arr.append((FixedTrait::from_felt(-82300887755675107328), FixedTrait::from_felt(75053094784167)));
    arr.append((FixedTrait::from_felt(-9748667062113009664), FixedTrait::from_felt(5507909937548864512)));
    arr.append((FixedTrait::from_felt(83116157601266073600), FixedTrait::from_felt(18446683067281709056)));
    arr.append((FixedTrait::from_felt(19106981540821303296), FixedTrait::from_felt(15676970957441302528)));
    arr.append((FixedTrait::from_felt(-73554699430984318976), FixedTrait::from_felt(616112261109368)));
    arr.append((FixedTrait::from_felt(-19812908245079228416), FixedTrait::from_felt(2608331168612691968)));
    arr.append((FixedTrait::from_felt(-54538667119184510976), FixedTrait::from_felt(28694347940898116)));
    arr.append((FixedTrait::from_felt(41991179732368687104), FixedTrait::from_felt(18236217986054639616)));
    arr.append((FixedTrait::from_felt(-74168657830972653568), FixedTrait::from_felt(535210877145306)));
    arr.append((FixedTrait::from_felt(-16391176946104401920), FixedTrait::from_felt(3451713922802126848)));
    arr.append((FixedTrait::from_felt(92903169780826439680), FixedTrait::from_felt(18446739695937429504)));
    arr.append((FixedTrait::from_felt(52553608135926808576), FixedTrait::from_felt(18406285205838954496)));
    arr.append((FixedTrait::from_felt(-88621271341219479552), FixedTrait::from_felt(14332726720611)));
    arr.append((FixedTrait::from_felt(-1394979431439794176), FixedTrait::from_felt(8667385730205541376)));
    arr.append((FixedTrait::from_felt(-85170498709129953280), FixedTrait::from_felt(35891466119948)));
    arr.append((FixedTrait::from_felt(-70940007271893762048), FixedTrait::from_felt(1108886206865101)));
    arr.append((FixedTrait::from_felt(143051195303529250816), FixedTrait::from_felt(18446744073709469696)));
    ...
    arr.append((FixedTrait::from_felt(-40477586112671940608), FixedTrait::from_felt(260230580704680672)));
    arr.append((FixedTrait::from_felt(-126212382742498312192), FixedTrait::from_felt(72036555)));
    arr.append((FixedTrait::from_felt(126233164890105839616), FixedTrait::from_felt(18446744073638080512)));
    arr.append((FixedTrait::from_felt(-3826201323985993728), FixedTrait::from_felt(7707813460083302400)));
    arr.append((FixedTrait::from_felt(102849911943925104640), FixedTrait::from_felt(18446743846064775168)));
    arr.append((FixedTrait::from_felt(-116320858887964426240), FixedTrait::from_felt(2644998313)));
    arr.append((FixedTrait::from_felt(-81236826171553710080), FixedTrait::from_felt(98084078694961)));
    ...
    arr.append((FixedTrait::from_felt(96539218442379591680), FixedTrait::from_felt(18446742538768048128)));
    arr.append((FixedTrait::from_felt(-21344647042975694848), FixedTrait::from_felt(2280324613129593856)));
    arr.append((FixedTrait::from_felt(62338658876034482176), FixedTrait::from_felt(18440043471955200000)));
    arr.append((FixedTrait::from_felt(-71250753459369213952), FixedTrait::from_felt(1035115721417319)));
    arr.append((FixedTrait::from_felt(-107074528678609387520), FixedTrait::from_felt(59536820837)));
    arr.append((FixedTrait::from_felt(106303691018135273472), FixedTrait::from_felt(18446743997375203328)));
    arr.append((FixedTrait::from_felt(-59271559794651824128), FixedTrait::from_felt(12110515485909394)));
    arr.append((FixedTrait::from_felt(-56802152671586189312), FixedTrait::from_felt(19140512788039108)));
    arr.append((FixedTrait::from_felt(43885956525637795840), FixedTrait::from_felt(18286656456710088704)));
    arr.append((FixedTrait::from_felt(-123881970537218867200), FixedTrait::from_felt(172682911)));
    arr.append((FixedTrait::from_felt(-49952225762593144832), FixedTrait::from_felt(62448907905773512)));
    arr.append((FixedTrait::from_felt(128324286661529534464), FixedTrait::from_felt(18446744073677371392)));
    arr.append((FixedTrait::from_felt(-8805306682425376768), FixedTrait::from_felt(5839523716517879808)));
    arr.append((FixedTrait::from_felt(45087762431150063616), FixedTrait::from_felt(18312849551109718016)));
    arr.append((FixedTrait::from_felt(-60765693305346424832), FixedTrait::from_felt(9106433841723674)));
    arr.append((FixedTrait::from_felt(-27786928184967200768), FixedTrait::from_felt(1217317851643367680)));
    arr.append((FixedTrait::from_felt(-32109509061986680832), FixedTrait::from_felt(753947928578102912)));
    ...
    arr.append((FixedTrait::from_felt(5412521098755178496), FixedTrait::from_felt(11352068958134509568)));
    arr
}
...
fn get_test_d1_d2_cases() -> (Array<(Fixed, Fixed, Fixed, Fixed)>, Array<(Fixed, Fixed)>) {
    ...
    arr.append((FixedTrait::from_felt(18446744073709560), FixedTrait::from_felt(18446744073709552), FixedTrait::from_felt(18446744073709551616), FixedTrait::from_felt(18446744073709551616)));
    arr.append((FixedTrait::from_felt(18446744073709560), FixedTrait::from_felt(18446744073709552), FixedTrait::from_felt(18446744073709551616), FixedTrait::from_felt(18446744073709551616)));
    arr.append((FixedTrait::from_felt(5091301364343836672), FixedTrait::from_felt(55340232221128656), FixedTrait::from_felt(46116860184273879040000), FixedTrait::from_felt(169119749667769169215488)));
    arr.append((FixedTrait::from_felt(18446744073709560), FixedTrait::from_felt(18446744073709552), FixedTrait::from_felt(18446744073709551616), FixedTrait::from_felt(18446744073709551616)));
    arr.append((FixedTrait::from_felt(21324436149208240128), FixedTrait::from_felt(1199038364791120896), FixedTrait::from_felt(154380801152875237474304), FixedTrait::from_felt(112709606290365360373760)));
    arr.append((FixedTrait::from_felt(18446744073709560), FixedTrait::from_felt(18446744073709552), FixedTrait::from_felt(18446744073709551616), FixedTrait::from_felt(18446744073709551616)));
    arr.append((FixedTrait::from_felt(1973801615886921984), FixedTrait::from_felt(36893488147419104), FixedTrait::from_felt(36395426057428945338368), FixedTrait::from_felt(95904622439215958851584)));
    arr.append((FixedTrait::from_felt(18446744073709560), FixedTrait::from_felt(18446744073709552), FixedTrait::from_felt(18446744073709551616), FixedTrait::from_felt(18446744073709551616)));
    arr.append((FixedTrait::from_felt(36893488147419103232), FixedTrait::from_felt(977677435906606208), FixedTrait::from_felt(28979834939797705588736), FixedTrait::from_felt(118077608815814839894016)));
    arr.append((FixedTrait::from_felt(18446744073709560), FixedTrait::from_felt(18446744073709552), FixedTrait::from_felt(18446744073709551616), FixedTrait::from_felt(18446744073709551616)));
    arr.append((FixedTrait::from_felt(22800175675105005568), FixedTrait::from_felt(18446744073709552), FixedTrait::from_felt(127190300388227358392320), FixedTrait::from_felt(96734725922532888674304)));
    arr.append((FixedTrait::from_felt(22800175675105005568), FixedTrait::from_felt(3910709743626424832), FixedTrait::from_felt(127190300388227358392320), FixedTrait::from_felt(96734725922532888674304)));
    arr.append((FixedTrait::from_felt(25825441703193370624), FixedTrait::from_felt(1014570924054025344), FixedTrait::from_felt(96734725922532888674304), FixedTrait::from_felt(3910709743626424942592)));
    arr.append((FixedTrait::from_felt(25825441703193370624), FixedTrait::from_felt(1014570924054025344), FixedTrait::from_felt(1014570924054025338880), FixedTrait::from_felt(3910709743626424942592)));
    arr.append((FixedTrait::from_felt(25825441703193370624), FixedTrait::from_felt(1014570924054025344), FixedTrait::from_felt(1014570924054025338880), FixedTrait::from_felt(3910709743626424942592)));
    arr.append((FixedTrait::from_felt(25825441703193370624), FixedTrait::from_felt(1014570924054025344), FixedTrait::from_felt(1014570924054025338880), FixedTrait::from_felt(3910709743626424942592)));
    arr.append((FixedTrait::from_felt(3910709743626424832), FixedTrait::from_felt(1014570924054025344), FixedTrait::from_felt(1014570924054025338880), FixedTrait::from_felt(3910709743626424942592)));
    arr.append((FixedTrait::from_felt(18446744073709560), FixedTrait::from_felt(18446744073709552), FixedTrait::from_felt(18446744073709551616), FixedTrait::from_felt(18446744073709551616)));
    arr.append((FixedTrait::from_felt(2969925795867237888), FixedTrait::from_felt(3283520445120300032), FixedTrait::from_felt(124072800639770444169216), FixedTrait::from_felt(180298476576437157494784)));
    arr.append((FixedTrait::from_felt(2969925795867237888), FixedTrait::from_felt(848550227390639360), FixedTrait::from_felt(124072800639770444169216), FixedTrait::from_felt(180298476576437157494784)));
    arr.append((FixedTrait::from_felt(2969925795867237888), FixedTrait::from_felt(848550227390639360), FixedTrait::from_felt(124072800639770444169216), FixedTrait::from_felt(180298476576437157494784)));
    arr.append((FixedTrait::from_felt(2969925795867237888), FixedTrait::from_felt(848550227390639360), FixedTrait::from_felt(2969925795867237810176), FixedTrait::from_felt(180298476576437157494784)));
    arr.append((FixedTrait::from_felt(2969925795867237888), FixedTrait::from_felt(848550227390639360), FixedTrait::from_felt(180298476576437157494784), FixedTrait::from_felt(180298476576437157494784)));
    arr.append((FixedTrait::from_felt(2969925795867237888), FixedTrait::from_felt(848550227390639360), FixedTrait::from_felt(2969925795867237810176), FixedTrait::from_felt(2969925795867237810176)));
    arr.append((FixedTrait::from_felt(21988518935861784576), FixedTrait::from_felt(6124319032471571456), FixedTrait::from_felt(124349501800876087443456), FixedTrait::from_felt(128518465961534446108672)));
    arr.append((FixedTrait::from_felt(21988518935861784576), FixedTrait::from_felt(6124319032471571456), FixedTrait::from_felt(124349501800876087443456), FixedTrait::from_felt(128518465961534446108672)));
    arr.append((FixedTrait::from_felt(21988518935861784576), FixedTrait::from_felt(6124319032471571456), FixedTrait::from_felt(21988518935861785526272), FixedTrait::from_felt(128518465961534446108672)));
    arr.append((FixedTrait::from_felt(21988518935861784576), FixedTrait::from_felt(3099053004383204864), FixedTrait::from_felt(21988518935861785526272), FixedTrait::from_felt(128518465961534446108672)));
    arr.append((FixedTrait::from_felt(21988518935861784576), FixedTrait::from_felt(3099053004383204864), FixedTrait::from_felt(21988518935861785526272), FixedTrait::from_felt(128518465961534446108672)));
    arr.append((FixedTrait::from_felt(11971936903837499392), FixedTrait::from_felt(516508834063867456), FixedTrait::from_felt(94465776401466613825536), FixedTrait::from_felt(94539563377761452032000)));
    arr.append((FixedTrait::from_felt(18981699651847127040), FixedTrait::from_felt(516508834063867456), FixedTrait::from_felt(516508834063867445248), FixedTrait::from_felt(94465776401466613825536)));
    arr.append((FixedTrait::from_felt(516508834063867456), FixedTrait::from_felt(92233720368547760), FixedTrait::from_felt(94465776401466613825536), FixedTrait::from_felt(516508834063867445248)));
    arr.append((FixedTrait::from_felt(18446744073709560), FixedTrait::from_felt(18446744073709552), FixedTrait::from_felt(94465776401466613825536), FixedTrait::from_felt(18446744073709551616)));
    ...
    target.append((FixedTrait::from_felt(291668633435675), FixedTrait::from_felt(-291668633435675)));
    target.append((FixedTrait::from_felt(1585771339775843237888), FixedTrait::from_felt(1585492477715412418560)));
    target.append((FixedTrait::from_felt(291668633435675), FixedTrait::from_felt(-291668633435675)));
    target.append((FixedTrait::from_felt(-16972960374592655360), FixedTrait::from_felt(-22409646176651464704)));
    target.append((FixedTrait::from_felt(291668633435675), FixedTrait::from_felt(-291668633435675)));
    target.append((FixedTrait::from_felt(3735166773356690669568), FixedTrait::from_felt(3735078502264946032640)));
    target.append((FixedTrait::from_felt(291668633435675), FixedTrait::from_felt(-291668633435675)));
    target.append((FixedTrait::from_felt(60526011704982298624), FixedTrait::from_felt(52032492894310309888)));
    target.append((FixedTrait::from_felt(291668633435675), FixedTrait::from_felt(-291668633435675)));
    target.append((FixedTrait::from_felt(-128819415131290238976), FixedTrait::from_felt(-129540419993143230464)));
    target.append((FixedTrait::from_felt(-3623118538600333312), FixedTrait::from_felt(-14121107788590913536)));
    target.append((FixedTrait::from_felt(-177223256978321539072), FixedTrait::from_felt(-183279859916774506496)));
    target.append((FixedTrait::from_felt(78834333252308828160), FixedTrait::from_felt(72777730313855860736)));
    target.append((FixedTrait::from_felt(78834333252308828160), FixedTrait::from_felt(72777730313855860736)));
    target.append((FixedTrait::from_felt(78834333252308828160), FixedTrait::from_felt(72777730313855860736)));
    target.append((FixedTrait::from_felt(501064441630978146304), FixedTrait::from_felt(500147298900298104832)));
    target.append((FixedTrait::from_felt(291668633435675), FixedTrait::from_felt(-291668633435675)));
    target.append((FixedTrait::from_felt(102124966375437303808), FixedTrait::from_felt(100871953309477306368)));
    target.append((FixedTrait::from_felt(199978245753020907520), FixedTrait::from_felt(199341267633525391360)));
    target.append((FixedTrait::from_felt(199978245753020907520), FixedTrait::from_felt(199341267633525391360)));
    target.append((FixedTrait::from_felt(2193840463900333047808), FixedTrait::from_felt(2193203485780837400576)));
    target.append((FixedTrait::from_felt(318489059747761088), FixedTrait::from_felt(-318489059747761088)));
    target.append((FixedTrait::from_felt(318489059747761088), FixedTrait::from_felt(-318489059747761088)));
    target.append((FixedTrait::from_felt(7220513475850757120), FixedTrait::from_felt(-5449148255134555136)));
    target.append((FixedTrait::from_felt(7220513475850757120), FixedTrait::from_felt(-5449148255134555136)));
    target.append((FixedTrait::from_felt(53754112958238507008), FixedTrait::from_felt(41084451227253194752)));
    target.append((FixedTrait::from_felt(71166929563872649216), FixedTrait::from_felt(62154318725786804224)));
    target.append((FixedTrait::from_felt(71166929563872649216), FixedTrait::from_felt(62154318725786804224)));
    target.append((FixedTrait::from_felt(1134271019703585408), FixedTrait::from_felt(-869017189822206592)));
    target.append((FixedTrait::from_felt(559635914547718062080), FixedTrait::from_felt(556459668680842805248)));
    target.append((FixedTrait::from_felt(-48531374030852731174912), FixedTrait::from_felt(-48531410553542644072448)));
    target.append((FixedTrait::from_felt(-4982344853156098614493184), FixedTrait::from_felt(-4982344853739435703926784)));

...
mod tests {
    ...
    #[test]
    fn test_get_fees() {
        let res1 = super::get_fees(FixedTrait::from_unscaled_felt(100));
        let res2 = super::get_fees(FixedTrait::from_unscaled_felt(200));
        let res3 = super::get_fees(FixedTrait::from_unscaled_felt(3));
        let res4 = super::get_fees(FixedTrait::from_unscaled_felt(10));
        let res5 = super::get_fees(FixedTrait::from_unscaled_felt(523));
